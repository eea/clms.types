...
class TestFullDatasetSourceVocabularyIntegrationTest(unittest.TestCase):
    """ test the vocabulary"""
    ...
    def test_vocabulary(self):
        ...
        """
        vocab_name = "clms.types.FullDatasetSourcesVocabulary"
        ...
        for dataset_source in DATASET_SOURCES:
            self.assertIn(dataset_source, vocabulary)
